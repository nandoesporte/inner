  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row font-sans">
      ...
      <main className="flex-1 flex flex-col min-h-0 overflow-hidden relative">
        ...
        <header className="bg-white/80 backdrop-blur-md border-b border-neutral-200/60 py-3 px-8 hidden md:flex justify-between items-center sticky top-0 z-10">
          ...
          <div className="flex items-center gap-6">
             <div className="text-right hidden lg:block">
                ...
                <p className="text-xs font-semibold text-neutral-600">Hoje, 10:15</p>
             </div>
